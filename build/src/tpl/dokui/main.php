...
?><!DOCTYPE html>
<html lang="en-gb" dir="ltr" class="uk-notouch dokuwiki"><head>
<meta charset="utf-8">
	...
	<nav class="tm-navbar uk-navbar uk-navbar-attached">
		<div class="uk-container uk-container-center">
			...
			<a class="uk-navbar-brand dw-navbar-brand uk-hidden-small" href="<?=DOKU_URL?>">
				<img src="<?=DOKU_TPL?>images/logo.png">
			...
			<?php if (!empty($_SERVER['REMOTE_USER'])) { ?>					
				<div class="uk-navbar-flip uk-hidden-small">
					<ul class="uk-navbar-nav">
						<li data-uk-dropdown>
							<a href=""><?=$INPUT->server->str('REMOTE_USER')?> <i class="uk-icon-caret-down"></i></a>
							<div class="uk-dropdown uk-dropdown-navbar">
								<ul class="uk-nav uk-nav-navbar">															
									<?php tpl_action('profile', 1, 'li') ?>			
									<li><a href="/<?=$INPUT->server->str('REMOTE_USER')?>/start" class="action" rel="nofollow" title="Your Private Namespace">Private Namespace</a></li>
...
<!--						<?php echo tpl_action('edit',1,'li',1,'<span>','</span>'); ?>-->
						<div class="actions">
							<?php tpl_action('edit',1,'span'); ?>
<!--							<?php tpl_action('backlink',1,'span'); ?>-->
							<?php tpl_action('subscribe',1,'span'); ?>
						</div>
		...
		<div class="uk-container uk-container-center uk-text-center">
			...
			<div class="uk-panel">
				...
				<a href="<?=DOKU_URL?>" class="dw-brand">			
					<img src="<?=DOKU_TPL?>images/logo.png">
					<!--<i class="uk-icon-cog"></i> <?=$conf['title']?>-->
				</a>
			</div>
